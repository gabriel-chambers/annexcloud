...
$_acf_resource_layout = get_field('resource_layout', $_post_id);
if (($_acf_resource_layout == 'asset'
    && get_field('resource_file_info_type', $_post_id) == 'external')
    || $_acf_resource_layout == 'external'
) {
    $_link_attributes['target'] = '_blank';
}
