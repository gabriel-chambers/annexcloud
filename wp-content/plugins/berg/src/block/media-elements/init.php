 ...
 */
function create_block_media_elements_block_init()
{
    ...
    register_block_type('e25m/media-elements', array(
        ...
        'render_callback' => 'render_media_elements_content'
    ));
}
add_action('init', 'create_block_media_elements_block_init');

function render_media_elements_content($attributes)
{
    ob_start();
