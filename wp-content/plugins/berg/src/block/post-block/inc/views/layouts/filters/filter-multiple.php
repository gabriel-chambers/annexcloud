<?php if ($showFilters) : ?>
	...
	<div class="selected-filters selected-filters-<?php echo $uniqidID; ?>">
		...
		<span><a class="clear-filters" style="<?php echo ($tags_count == 0) ? 'display:none' : '' ?>" href="<?php echo esc_url(home_url($page_slug)); ?>"><?php echo __('Clear Filters', 'blankslate'); ?></a></span>
	</div>
<?php endif; ?>
