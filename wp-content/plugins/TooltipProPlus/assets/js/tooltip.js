			 ...
			 */
                        if ( opts.link_whole_tt ) {
                                ...
                                jQuery( 'body' ).on( 'click touchstart', function ( e ) {
                                        ...
                                        var hasLink = typeof currentElement !== 'undefined' && null !== currentElement && currentElement.tagName === 'SPAN' && jQuery(currentElement).data('link');
                                        ...
                                        if(tooltipVisible && tooltipWrapperClicked && hasLink){
                                            CM_Tooltip.redirecting = true;
                                            window.location = jQuery(currentElement).data('link');
                                        }
                                } );
                        }
...
(
    function ( $ ) {
		 ...
		 */
                ...
                /* fix for Facetwp popups */
                $( document ).on( "click",'.facetwp-template', function () {
                    $( document ).trigger( 'glossaryTooltipReady' );
                } );
