...
$config = [
    ...
    'settings' => [
        ...
        'cmtt_index_resultsLabel'                            => ['value' => 'Results:',],
        ...
        'cmtt_glossary_relatedArticlesPrefixNotGlossary' => ['value' => '',],
        ...
        'cmtt_glossaryProtectedTags'                     => ['value' => ['all_h', 'h1', 'a', 'other']], //Avoid the use of Glossary in Protected tags?
        ...
        'cmtt_glossaryParseOxygenBuilder'                 => ['value' => 0,],
