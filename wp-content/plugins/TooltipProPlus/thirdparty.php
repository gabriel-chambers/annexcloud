...
class CMTT_Google_API {
	...
	public static function getApiKey() {
		return \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleApiKey', '');
	}
	...
	public static function translateShortcode($atts) {
		extract(shortcode_atts(array(
			'term' => '',
			'source' => \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleSource', -1),
			'target' => \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleTarget', -1)
		), $atts));
	...
	public static function testGoogle() {
		...
		$source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleSource', -1);
		$target_id = \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleTarget', -1);
	...
	public static function translate($term, $termTitle, $column = self::COLUMN_TITLE, $onGlossaryIndex = FALSE) {
		...
		if ((self::getApiKey() != '') && $source_id != -1 && $target_id != -1 && !empty($term)) {
			...
			if ($result === false && (!$onGlossaryIndex || \CM\CMTT_Settings::get('cmtt_glossaryRunApiCalls') == 1)) {
	...
	public static function enabled() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleEnabled', 0);
	}

	public static function term() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleTerm', 0);
	}

	public static function together() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RDGoogleTogether', 0);
	}
...
//        }
	...
	public static function testDictionary() {
		...
		if (($key != '')) {
			...
			$uri = "https://www.dictionaryapi.com/api/v1/references/collegiate/xml/" . urlencode($termCacheName) . "?key=" . urlencode($key);
	...
	public static function testThesaurus() {
		...
		if (($key != '')) {
			...
			$uri = "https://www.dictionaryapi.com/api/v1/references/thesaurus/xml/" . urlencode($termCacheName) . "?key=" . urlencode($key);
			if (function_exists('curl_version')) {
				$curl = curl_init();
				curl_setopt($curl, CURLOPT_URL, $uri);
				curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
	...
	public static function getApiKey_Dictionary() {
		return \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWDictionaryApiKey', '');
	}

	public static function getApiKey_Thesaurus() {
		return \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWThesaurusApiKey', '');
	}
	...
	public static function dictionary_enabled() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWDictionaryEnabled', 0);
	}

	public static function dictionary_only_on_empty_content() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWDictionaryAutoContent', 0);
	}

	public static function dictionary_show_in_tooltip() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWDictionaryTooltip', 0);
	}

	public static function dictionary_show_in_term() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWDictionaryTerm', 0);
	}
	...
	public static function thesaurus_enabled() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWThesaurusEnabled', 0);
	}

	public static function thesaurus_only_on_empty_content() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWThesaurusAutoContent', 0);
	}

	public static function thesaurus_show_in_tooltip() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWThesaurusTooltip', 0);
	}

	public static function thesaurus_show_in_term() {
		return $source_id = \CM\CMTT_Settings::get('cmtt_tooltip3RD_MWThesaurusTerm', 0);
	}
