...
if ( !class_exists( __NAMESPACE__ . '\CmindsProPackageTGPLUSPRO' ) ) {

    class CmindsProPackageTGPLUSPRO {
        ...
        public function updateMenu() {
            ...
            if ( $this->getOption( 'plugin-is-pro' ) && !$this->getOption( 'plugin-is-addon' ) ) {
                ...
                if ( $this->getOption( 'plugin-has-addons' ) ) {
                    add_submenu_page( $this->getOption( 'plugin-menu-item' ), __( 'Add-ons', 'cminds-package' ), __( 'Add-ons', 'cminds-package' ), 'manage_options', $this->getAddonsSlug(), array( $this, 'displayPage' ) );
                }
            }
        ...
        public function enqueueAdminScripts() {
			...
			wp_enqueue_style('cmtgpluspro-custom', plugin_dir_url(__FILE__) . 'css/custom.css', array());
			wp_enqueue_script('cmtgpluspro-custom', plugin_dir_url(__FILE__) . 'js/custom.js', array(), $this->getOption('plugin-version'), true);
...
$cmindsPluginPackage[ $cminds_plugin_config[ 'plugin-abbrev' ] ] = new CmindsProPackageTGPLUSPRO( $cminds_plugin_config );