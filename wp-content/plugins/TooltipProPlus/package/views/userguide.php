		...
		<div id="buy" class="buy postbox">
			...
			<div class="plugins">
				<div class="list">
					...
					<div class="plugins-table">
						<div class="plugins-img item">
							<a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/cm-answer-store-page-content/' ); ?>" target="_blank">
						...
						<div class="plugins-action item">
							<a class="button-success" href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/cm-answer-store-page-content/' ); ?>" target="_blank" >More Info</a>
						</div>
					</div>
					...
					<div class="plugins-table">
						<div class="plugins-img item">
							<a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/pop-up-banners-plugin-for-wordpress/' ); ?>" target="_blank">
						...
						<div class="plugins-action item">
							<a class="button-success" href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/pop-up-banners-plugin-for-wordpress/' ); ?>" target="_blank" >More Info</a>
						</div>
					</div>
					...
					<div class="plugins-table">
						<div class="plugins-img item">
							<a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/video-lessons-manager-plugin-for-wordpress/' ); ?>" target="_blank">
						...
						<div class="plugins-action item">
							<a class="button-success" href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/video-lessons-manager-plugin-for-wordpress/' ); ?>" target="_blank" >More Info</a>
						</div>
					</div>
					<!--  FAQ  Plugin -->
					<div class="plugins-table">
					...
					<div class="plugins-table">
						<div class="plugins-img item">
							<a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/search-and-replace-plugin-for-wordpress/' ); ?>" target="_blank">
						...
						<div class="plugins-action item">
							<a class="button-success" href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/search-and-replace-plugin-for-wordpress/' ); ?>" target="_blank" >More Info</a>
						</div>
					</div>
					<!--  Cm Map Routes Plugin -->
					<div class="plugins-table">
						<div class="plugins-img item">
							<a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/google-maps-routes-manager-plugin-for-wordpress-by-creativeminds/' ); ?>" target="_blank">
						...
						<div class="plugins-action item">
							<a class="button-success" href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/wordpress-plugins-library/google-maps-routes-manager-plugin-for-wordpress-by-creativeminds/' ); ?>" target="_blank" >More Info</a>
						</div>
					</div>
