...
class CMTT_Post_Embed {
    ...
    static function getLabel( $key ) {
        $labels = array(
            'embed_button_text'     => \CM\CMTT_Settings::get('cmtt_embed_text','Embed'),
            'embed_label'           => \CM\CMTT_Settings::get('cmtt_embed_glossary_text','Embed Glossary Term'),
            'copy_instruction'      => \CM\CMTT_Settings::get('cmtt_embed_copy_html_text','Copy the following HTML iframe code to your website:'),
            'copy_clipboard_button' => \CM\CMTT_Settings::get('cmtt_embed_copy_clipboard_text','Copy to clipboard'),
        );
    ...
    static function plugins_loaded() {
        if ( \CM\CMTT_Settings::get( 'cmtt_embed_enabled', '0' ) ) {
