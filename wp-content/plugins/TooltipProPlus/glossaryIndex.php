...
//		add_filter( 'cmtt_glossary_index_listnav_content', array( __CLASS__, 'modifyListnav' ), 10, 3 );
	...
	public static function outputScripts() {
		...
		$embeddedMode    = \CM\CMTT_Settings::get( 'cmtt_enableEmbeddedMode', false );
		$inFooter        = \CM\CMTT_Settings::get( 'cmtt_script_in_footer', true );
        $isGlossaryTerm  = $post && isset( $post->post_type ) && $post->post_type == 'glossary'; // TRUE if is glossary term page, FALSE otherwise
        ...
        $disableTooltipForMobile = (int)\CM\CMTT_Settings::get( 'cmtt_glossaryMobileDisableTooltips', '0' );
		...
		if( $forceLoad || (!($disableTooltipForMobile && $is_mobile) && !($disableTooltipForDesktop && !$is_mobile))){
            $tooltipData = array();
            ...
            $tooltipArgs                             = array(
                ...
                'title_background'        => \CM\CMTT_Settings::get( 'cmtt_tooltipTitleColor_background' ),
            ...
            $tooltipData['footnote_background_color']= empty(\CM\CMTT_Settings::get( 'cmtt_footnoteBackgroundColor', '#eaf3ff' )) ? '#eaf3ff' : \CM\CMTT_Settings::get( 'cmtt_footnoteBackgroundColor', '#eaf3ff' );
	...
	public static function getDynamicCSS() {
		...
		.cm-glossary.grid ul.glossaryList li:not(.the-index-letter)  { width: <?php echo \CM\CMTT_Settings::get( 'cmtt_glossaryGridColumnWidth', '200px' ); ?> !important}
		...
		<?php
            $background_color = \CM\CMTT_Settings::get( 'cmtt_letter_background_color_accordion_view', '' );
            $active_item_color = \CM\CMTT_Settings::get( 'cmtt_active_item_color_accordion_view', '' );
            $letter_color = \CM\CMTT_Settings::get( 'cmtt_letter_color_accordion_view', '' );
            $alphabet_color = \CM\CMTT_Settings::get( 'cmtt_alphapet_color_accordion_view', '' );
            $icon_color = \CM\CMTT_Settings::get( 'cmtt_icon_color_accordion_view', '#8e2c85' );
            ?>

            .cm-glossary.accordion-view .ln-letters a{
            color: <?php echo $alphabet_color; ?>;
            width: fit-content;
            border: none;
            font-weight: bold;
            ...
            color: <?php echo $active_item_color; ?> !important;
            }
            ...
            .cm-glossary.accordion-view .the-index-letter > * {
            color: <?php echo $letter_color; ?>;
            }

        <?php

            $default_title_color = \CM\CMTT_Settings::get( 'cmtt_default_item_color_card_view', '#000' );
            $description_color = \CM\CMTT_Settings::get( 'cmtt_term_definition_color_card_view', '#000' );
            $alphabet_color = \CM\CMTT_Settings::get( 'cmtt_alphabetical_index_color_card_view', '#000' );
            $alphabet_separator_color = \CM\CMTT_Settings::get( 'cmtt_alphabetical_separator_color_card_view', '#000' );
            $active_item_title_color = \CM\CMTT_Settings::get( 'cmtt_active_item_color_card_view', '#6bd386' );
            ?>
            ...
            .cm-glossary.cards-view .ln-letters a{
                color: <?php echo empty($alphabet_color) ? '#000' : $alphabet_color; ?>;
                width: fit-content;
                border: none;
                font-weight: bold;
                display: inline-block;
            ...
            .cm-glossary.cards-view .glossaryList li.the-index-letter{
                ...
                font-size: 30px;
                font-weight: bold;
                color: <?php echo empty($alphabet_separator_color) ? '#000' : $alphabet_separator_color; ?>;
            }
            ...
            .cm-glossary.cards-view .glossaryList li:not(.the-index-letter, .the-letter-separator){
                ...
                color: <?php echo empty($default_title_color) ? '#000' : $default_title_color; ?>;
            ...
            .cm-glossary.cards-view .glossaryList li .glossary-link-title {
                color: <?php echo empty($default_title_color) ? '#000' : $default_title_color; ?> !important;
                border: none !important;
            }

            .cm-glossary.cards-view .glossaryList li .glossary_itemdesc {
                color: <?php echo empty($description_color) ? '#000' : $description_color; ?> !important;
            }
            ...
            .cm-glossary.cards-view .glossaryList li:not(.the-index-letter, .the-letter-separator):hover{
                ...
                border-top-color: <?php echo empty($active_item_title_color) ? '#6bd386' : $active_item_title_color; ?>;
            ...
            .cm-glossary.cards-view .glossaryList li:hover .glossary-link-title span{
                color: <?php echo empty($active_item_title_color) ? '#6bd386' : $active_item_title_color; ?> !important;
            }
	...
	public static function addScriptParams( $shortcodeAtts ) {
		...
		$tooltipData['accordion_open_icon']      = \CM\CMTT_Settings::get( 'cmtt_open_icon_accordion_view', '' );
		$tooltipData['accordion_close_icon']     = \CM\CMTT_Settings::get( 'cmtt_close_icon_accordion_view', '' );
        ...
        if(\CM\CMTT_Settings::get( 'cmtt_glossaryDisplayStyle', '' ) == 'cards-view'){
            $scriptsConfig['styles']['animate-css'] = array(
                'path' => self::$cssPath . 'animate.css',
            );
        }
	...
	public static function glossaryShortcode( $atts = array() ) {
		...
		$default_atts   = apply_filters(
			...
			array(
				...
				'pagination_position'  => \CM\CMTT_Settings::get( 'cmtt_glossaryPaginationPosition', 'bottom' ),
				'disable_listnav'      => ! apply_filters( 'cmtt_index_enabled', \CM\CMTT_Settings::get( 'cmtt_index_enabled', 0 ) ),
			)
		);
    ...
    public static function filterIndexByLetter($glossary_index, $currentlySelectedLetter, $sortByTitle,$ignore_cache=false){
        $enabled_caching = CMTT_Free::canCacheIndex();
        $hash = CMTT_Free::_get_hash( CMTT_Free::$lastQueryDetails['ids'], 'filtered_' . $currentlySelectedLetter );
        if ( !$enabled_caching && \CM\CMTT_Settings::get( 'cmtt_glossaryClearCaches', false ) ) {
            CMTT_Cache::delete_cache($hash, 'glossary_filtered');
        }
        if ( $enabled_caching && !$ignore_cache ) {
            $cached_glossary_index =  CMTT_Cache::get_cache($hash, 'glossary_filtered');
            if ( !empty($cached_glossary_index) ) {
                return $cached_glossary_index;
            }
        }
        $nonLatinLetters = (bool)\CM\CMTT_Settings::get('cmtt_index_nonLatinLetters');
        if ( !empty($currentlySelectedLetter) && 'all' !== $currentlySelectedLetter ) {
            $glossary_index = array_filter($glossary_index, function ($glossaryItem) use ($currentlySelectedLetter, $sortByTitle, $nonLatinLetters) {
                $letter = CMTT_Free::getFirstLetter($glossaryItem, $sortByTitle);
                if ( !$nonLatinLetters ) {
                    $letter = remove_accents($letter);
                }

                return $currentlySelectedLetter === $letter;
            });
        }
        if ( $enabled_caching ) {
            CMTT_Cache::set_cache($glossary_index, $hash, 'glossary_filtered');
        }
	...
	public static function outputGlossaryIndexPage( $shortcodeAtts ) {
		...
		$args = array(
			...
			'exact'                  => $shortcodeAtts['exact_search'] ?? false,
			'nopaging'               => true
		);
        ...
        $glossary_query = CMTT_Free::$lastQueryDetails['query'] ?? null;
		...
		if ( ! empty( $shortcodeAtts['search_term'] ) ) {
            ...
            $search_term = preg_quote($shortcodeAtts['search_term'], '/');
            $regex = "/$search_term/i";
            $glossary_index = array_filter($glossary_index, function ($glossaryItem) use ($regex, $search_in) {
                return
                    (in_array('0', $search_in) && preg_match($regex, $glossaryItem->post_title)) ||
                    (in_array('1', $search_in) && preg_match($regex, $glossaryItem->post_content));
            });
		}
        ...
        if ( $serverSidePagination && $limit_terms = (int) \CM\CMTT_Settings::get( 'cmtt_limitNum', 0 ) ) {
			...
			$glossary_index = array_filter( $glossary_index, function ( $glossaryItem ) use ( $limit_terms, &$firstLettersArr ) {
                ...
                return $firstLettersArr[ $firstLetter ] <= $limit_terms;
			} );
		}
        ...
        if(( ! empty( $shortcodeAtts['search_term'] ) && \CM\CMTT_Settings::get( 'cmtt_glossary_ignore_letter_on_search', 0 ) )){
            $currentlySelectedLetter = 'all';
        } else {
        ...
        $glossary_index = self::filterIndexByLetter($glossary_index, $currentlySelectedLetter, $sortByTitle,$force_cache_update);

		$numberOfPages = 1;
		if ( $serverSidePagination ) {
            $postsPerPage = (int) ( isset( $shortcodeAtts['perpage'] ) && is_numeric( $shortcodeAtts['perpage'] ) ? $shortcodeAtts['perpage'] : \CM\CMTT_Settings::get( 'cmtt_perPage', 50 ) );
            $currentPage  = (int) ( isset( $shortcodeAtts['itemspage'] ) && is_numeric( $shortcodeAtts['itemspage'] ) ? $shortcodeAtts['itemspage'] : 1 );
            if ( ! $postsPerPage ) {
		...
		if ( ! empty( $glossary_index ) ) {
            ...
            if ( $enabled_caching ) {
                $hash                  = CMTT_Free::_get_hash( CMTT_Free::$lastQueryDetails['ids'], 'sorted_' . $currentlySelectedLetter );
                if(!$force_cache_update) {
                    $glossary_index_sorted = CMTT_Cache::get_cache($hash, 'glossary_index_sorted');
			...
			if ( ! $sorted ) {
				...
				if ( $enabled_caching && is_array( $glossary_index )  ) {
                    CMTT_Cache::set_cache($glossary_index, $hash, 'glossary_index_sorted');
                }
			} else {
			...
			if ( $serverSidePagination ) {
				$glossary_index = array_slice( $glossary_index, (int)(( $currentPage - 1 ) * $postsPerPage), $postsPerPage );
			}
	...
	protected static function maybeOutputSingleTerm(
        ...
        if(!self::isServerSide()) {
            $customLetter = CMTT_Free::_get_meta('_cmtt_custom_index_letter', $glossaryItem->ID);

            if ( isset($customLetter) && mb_strlen( $customLetter )) {
                $termLetter = mb_substr($customLetter, 0, 1);
                $customAttrBase .= ' data-cl="' . $termLetter . '"';
            }
        }
		...
		if ( ! $tooltipsDisabled && ! $excludeTT && ! $disableTooltipForTerm && !($disableTooltipForMobile && $is_mobile) && !($disableTooltipForDesktop && !$is_mobile)) {
		...
		if($glossaryIndexStyle == 'accordion-view'){
            $open_icon = \CM\CMTT_Settings::get( 'cmtt_open_icon_accordion_view', 'dashicons-arrow-down-alt2' );
            $itemContent .= "<span class='dashicons {$open_icon}'></span>";
        }
		
		/*
		 * Insert post term title
		 */
        $termTitle = \CM\CMTT_Settings::get( 'cmtt_glossaryAbbreviationsInTitleOnIndex', 0 ) ? CMTT_Glossary_Plus::addAbbreviation($glossaryItem->post_title,$glossaryItem->ID) :$glossaryItem->post_title;
		$replacedTitle = apply_filters( 'cmtt_glossaryItemTitle', $termTitle, $glossaryItem, 1 );
		$itemContent   .= $replacedTitle;

        if($glossaryIndexStyle !== 'cards-view'){
            $itemContent .= '</' . $tag . '>';
        }
	...
	public static function outputPagination( $content, $lastPage, $shortcodeAtts ) {
        ...
        if(isset($shortcodeAtts['letter']) && ! empty( $shortcodeAtts['letter'] ) && $shortcodeAtts['letter'] !== 'all'){
            $glossaryPageLink = add_query_arg( array( 'letter' => $shortcodeAtts['letter'] ), $glossaryPageLink );
        }
	...
	public static function compareGlossaryTerms( $obj1, $obj2 ) {
		...
		if ( isset( $customLetter[ $obj1->ID ] ) && is_string( $customLetter[ $obj1->ID ] ) && mb_strlen( $customLetter[ $obj1->ID ] ) ) {
			$s1 = mb_substr( $customLetter[ $obj1->ID ], 0, 1 ) . $s1;
		}

		if ( isset( $customLetter[ $obj2->ID ] ) && is_string( $customLetter[ $obj2->ID ] ) && mb_strlen( $customLetter[ $obj2->ID ] ) ) {
			$s2 = mb_substr( $customLetter[ $obj2->ID ], 0, 1 ) . $s2;
		}
		...
		if ( true === extension_loaded( 'intl' ) ) {
			...
			if ( null === $collator ) {
				 ...
				 */
                if(\CM\CMTT_Settings::get( 'cmtt_enable_numeric_sorting', 1 )){
