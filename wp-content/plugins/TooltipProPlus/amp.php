...
class CMTT_AMP {
	...
	public static function outputSimpleTooltipContent( $postItemTitleContent, $glossaryItem, $glossaryIndexStyle, $id ) {
		...
		if ( CMTT_AMP::is_amp_endpoint() ) {
            ...
            $addLinkAfterDesc        = \CM\CMTT_Settings::get( 'cmtt_glossaryAddTermPagelinkAfterDescription' );
			...
			$title_styles .= 'padding:' . \CM\CMTT_Settings::get( 'cmtt_tooltipPaddingTitle', '10px 0 10px 10px' ) . ';';
            ...
            <?php echo ( function_exists( 'ampforwp_is_amp_endpoint' ) && ampforwp_is_amp_endpoint() ) ? "&#215;" : ""; ?>
                ...
                <span id="ttcont" style="<?php echo $ttcont_styles; ?>">
                    ...
                    <?php if ( $addLink && $createGlossaryTermPages && $addLinkAfterDesc ): ?>
