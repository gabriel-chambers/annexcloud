        ...
        <div class="bs-row row bs-row---default">
            <div class=" bs-column col-sm-12 col-xl-10 bs-column---default">
                <h1 class="wp-block-heading has-space-blue-color has-text-color">
                    Functionality : <?php single_tag_title(); ?>
                </h1>
            </div>
        </div>
    </div>
...
<section class="wp-block-e25m-section bs-section---default bs-section--use-case-posts bs-section--use-case-categories">
    <div class="container">
                    ...
                    <div class="bs-posts ">
                        <div class="bs-posts__list row">
                            ...
                            $args = array(
                                ...
                                'tax_query' => array(
                                    array(
                                        'taxonomy' => 'usecase-functionality',
                                        'field' => 'term_id',
                                        'terms' => $tag_id,
                                    )
                                ),
                            ...
                            ?>
                                ...
                                <div class="bs-posts__column col-sm-12 col-md-4">
                                    <div class="bs-post bs-post-blog has-image
                                     bs-post__slide-down<?= $learn_more_cls; ?>" data-post-id="<?= $post_id; ?>"
                                      data-post-slug="<?= $post_slug ?>" oncontextmenu="return false;">
                                                ...
                                                <div class="bs-post__image">
                                                    <figure class="figure">
                                                        <img src="<?php echo $image_url; ?>" class="img-fluid"
                                                         alt="<?php echo $image_alt; ?>" loading="lazy">
                                                    </figure>
                                                </div>
                                            <?php endif; ?>
                                ...
                                if ($learn_more_type == "po_link") { ?>
                                    <div class="bs-post__target bs-post__target--popup-post
                                     bs-post__slide-down-content " id="bs-post__popup--<?= $post_id; ?>"
                                      data-post-id="<?= $post_id; ?>" data-post-slug="<?= $post_slug; ?>"
                                      style="display: none;">
